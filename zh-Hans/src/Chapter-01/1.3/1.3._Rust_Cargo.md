...
**[1.2. Rust的基本认识与打印“Hello World”](../1.2/1.2._Basic_Understanding_of_Rust_and_Printing_"Hello_World".md)** 文章的末尾提到了只有小型简单的Rust项目适合使用`rustc`来编译，大型项目需要**Cargo**,本篇就对Cargo进行详细的介绍
