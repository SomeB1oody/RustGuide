...
Web 服务器涉及的两个主要协议是*超文本传输协议*(Hypertext Transfer Protocol，简称HTTP)和*传输控制协议*(Transmission Control Protocol，简称TCP)。这两种协议都是*请求-响应*协议，即*客户端*发起请求，然后*服务器*监听请求并向客户端提供响应。这些请求和响应的内容由协议定义。
