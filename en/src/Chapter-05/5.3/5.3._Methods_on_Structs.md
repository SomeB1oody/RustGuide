...
Let’s continue with an example from the previous article, [5.2. Struct Usage Example - Printing Debug Information](../5.2/5.2._Struct_Usage_Example_-_Printing_Debug_Information.md):
```rust
struct Rectangle {
    width: u32,
    length: u32,
