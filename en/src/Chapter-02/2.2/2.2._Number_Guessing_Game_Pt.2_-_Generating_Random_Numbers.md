...
Next, add the external crate to Cargo dependencies (Cargo was introduced in **[1.3. Rust Cargo](../../Chapter-01/1.3/1.3._Rust_Cargo.md)**, so I will not repeat that here) so that the program can use it.
