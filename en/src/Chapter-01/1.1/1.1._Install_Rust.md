...
![Terminal showing Rust installer menu with three installation options](./Rust_intsall.png)
...
![Terminal confirming Rust installed successfully](./Rust_finish_installing.png)
...
![Terminal output of rustc -V showing version 1.83.0](./Rust_version.png)
