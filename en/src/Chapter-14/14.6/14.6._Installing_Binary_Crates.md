...
For example, in [Chapter 12](../../Chapter-12/12.1/12.1._Receiving_Command-Line_Arguments.md) we mentioned the Rust implementation of the `grep` tool, called `ripgrep`, which is used to search files. To install `ripgrep`, we can run:
```text
