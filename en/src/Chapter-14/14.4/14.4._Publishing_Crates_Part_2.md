...
just1a1nexample
```
This command tells Cargo your API token and stores it locally in `~/.cargo/credentials.toml`. Note that **this token must not be shared with anyone else. If you leak it, you should revoke it and generate a new token on [crates.io](https://crates.io/).**
