...
In the guessing game from Chapter 1, we already used the third-party `rand` crate from [crates.io](https://crates.io/) to get random numbers. We can use crates provided by others, and we can also publish our own crates to [crates.io](https://crates.io/) for others to use.
