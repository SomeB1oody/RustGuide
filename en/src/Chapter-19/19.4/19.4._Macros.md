...
### Function-Like Macros
Function-like macros are also called *function macros*. Their definitions look like function-call macros. They are similar to `macro_rules!` macros, but more flexible than functions; for example, they can accept an unknown number of arguments.

Function-like macros can take a `TokenStream` as input, and like the other two procedural macro forms, they use Rust code in the definition to operate on that `TokenStream`.
