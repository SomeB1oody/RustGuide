...
Using the code from [7.4. Keyword Use Pt. 1 - Using Use and the As Keyword](../7.4/7.4._Keyword_Use_Pt._1_-_Using_Use_and_the_As_Keyword.md) as an example:
```rust
mod front_of_house {
    pub mod hosting {
...
Do you remember the guessing game from [2.2. Number Guessing Game Pt. 2 - Generating Random Numbers](../../Chapter-02/2.2/2.2._Number_Guessing_Game_Pt.2_-_Generating_Random_Numbers.md)? Back then we needed the `rand` package to generate random numbers. We will still use `rand` as an example:
