...
![File explorer showing front_of_house.rs created under src](./colunm.png)
...
```
![Editor showing hosting module code pasted into front_of_house.rs](./paste_codes.png)
...
```
![lib.rs declaring mod front_of_house with a semicolon beside front_of_house.rs](./add;.png)
...
![File explorer with front_of_house folder containing hosting.rs](./n_file_n_folder.png)
...
pub mod hosting;
```
![Split editor showing lib.rs, front_of_house.rs with mod hosting;, and hosting.rs](./hosting.png)
...
![Project using front_of_house/mod.rs and hosting/mod.rs module layout](./mod_rs.png)
