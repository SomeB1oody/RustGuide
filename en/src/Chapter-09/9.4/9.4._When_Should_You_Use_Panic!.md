...
[Chapter 9.1, “Unrecoverable Errors and `panic!`”](../9.1/9.1._Unrecoverable_Errors_and_Panic!.md), already explained that Rust has two kinds of errors: recoverable and unrecoverable.
...
Take the number guessing game from [2.1. Number Guessing Game Pt. 1](../../Chapter-02/2.1/2.1._Number_Guessing_Game_Pt.1_-_One_Guess.md) as an example. Some code has been omitted:
```rust
fn main() {
	loop {
        // --snip--
