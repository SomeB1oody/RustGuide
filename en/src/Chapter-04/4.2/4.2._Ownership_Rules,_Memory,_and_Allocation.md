...
- [Ownership and Functions](../4.3/4.3._Ownership_and_Functions.md)
...
![String machine on the stack with pointer, length, and capacity pointing to heap data Niko](./IMG_1218.jpeg)
...
![Variables machine and wjq both pointing to the same heap data Niko](./IMG_1220.jpeg)
...
![Cloned strings machine and wjq each with their own heap copy of Niko](./IMG_1221.jpeg)
