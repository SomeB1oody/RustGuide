...
After learning references, you can simplify the example at the end of the previous article, [4.3. Ownership and Functions](../4.3/4.3._Ownership_and_Functions.md).
...
![Reference s pointing to String s1, which points to heap data hello](./reference.png)
