...
Let’s continue using the content from [10.3 Trait Pt.1 - Trait Definitions, Bounds, and Implementation](../10.3/10.3._Trait_Pt.1_-_Trait_Definitions,_Bounds,_and_Implementation.md) as the example:
```rust
pub trait Summary {
