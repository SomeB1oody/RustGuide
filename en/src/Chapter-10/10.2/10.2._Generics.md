...
Using the code from [10.1. Extract Function to Eliminate Repeated Code](../10.1/10.1._Extract_Function_to_Eliminate_Repeated_Code.md) as an example, here it is with a small generic modification:
```rust
fn largest<T>(list: &[T]) -> T{
