...
The main purpose of lifetimes is to avoid dangling references. This concept was already discussed in [4.4. Reference and Borrowing](../../Chapter-04/4.4/4.4._Reference_and_Borrowing.md), and I’ll repeat the earlier explanation here:
...
The phrase “the same” is not entirely precise, because the actual lifetimes of the `x` and `y` values in `main` differ a little. We will talk about that in [10.6. Lifetime Syntax and Examples](../10.6/10.6._Lifetime_Syntax_and_Examples.md).
