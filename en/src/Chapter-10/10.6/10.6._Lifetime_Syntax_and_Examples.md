...
Take the code from [10.5. Lifetime Definition and Significance, Borrow Checker, and Generic Lifetimes](../10.5/10.5._Lifetime_Definition_and_Significance,_Borrow_Checker,_and_Generic_Lifetimes.md) as an example:
```rust
fn main() {  
...
That is why in [10.5. Lifetime Definition and Significance, Borrow Checker, and Generic Lifetimes](../10.5/10.5._Lifetime_Definition_and_Significance,_Borrow_Checker,_and_Generic_Lifetimes.md) and earlier in this article, the word “same” was placed in quotes: it does not mean literally identical lifetimes, but rather the overlapping part.
